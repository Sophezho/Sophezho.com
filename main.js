(function () {
  ...
  function buildSelector() {
    galleries.forEach(function (gallery) {
      ...
      // Uses gallery.cover if you set one in projects.js, otherwise
      // falls back to the first work image automatically.
      ...
      card.innerHTML =
        ...
        '<div class="works-card__count">' + gallery.items.length + ' works</div>';
  ...
  function openCategory(key) {
    ...
    gallery.items.forEach(function (item, index) {
      ...
      // first few load immediately, the rest lazily as the user scrolls
